...
import 'package:absensi_app/core/components/custom_date_picker.dart';
...
class _PermissionPageState extends State<PermissionPage> {
  ...
  String formatDate(DateTime date) {
    // Gunakan DateFormat jika ingin menyesuaikan formatnya
    final dateFormatter = DateFormat('yyyy-MM-dd');
    // Kembalikan tanggal dalam format yg di inginkan
                  ...
                  return Button.filled(
                    onPressed: () {
                      ...
                      context.read<PermissionsBloc>().add(
                            PermissionsEvent.addPermissions(
