...
class RegisterFaceAttendancePage extends StatefulWidget {
  ...
  @override
  State<RegisterFaceAttendancePage> createState() => _RegisterFaceAttendancePageState();
}

class _RegisterFaceAttendancePageState extends State<RegisterFaceAttendancePage> {
  ...
  void _reverseCamera() async {
    ...
    //   _controller;
    // });
    // Initialisasi kamera dengan deskripsi kamera terbaru
    _initializeCamera();
  }
